...
public class JSON {
	...
	public static String TAG = "JSON.java";

	public final ArrayList<NodeCategory> All;

	public JSON(String json) throws JSONException {

		final JSONObject cat = new JSONObject(json.toString());

		final ArrayList<NodeCategory> data = new JSONParser().getResults(cat);
